...
export function GroupDetailPage() {
  ...
  async function handleJoin() {
    ...
    try {
      ...
      setActionError(err instanceof ApiClientError ? err.message : 'تعذر الانضمام.');
    } finally {
      setBusy(false);
    }
  }
  ...
  async function handleLeave() {
    ...
    try {
      ...
      setActionError(err instanceof ApiClientError ? err.message : 'تعذر مغادرة المجموعة.');
      setBusy(false);
    }
  }
  ...
  async function handleAddMember() {
    ...
    try {
      ...
      setActionError(err instanceof ApiClientError ? err.message : 'تعذر إضافة العضو.');
    } finally {
      setBusy(false);
    }
  }
  ...
  async function handleCreateEvent() {
    ...
    try {
      ...
      setActionError(err instanceof ApiClientError ? err.message : 'تعذر إنشاء الفعالية.');
    } finally {
      setBusy(false);
    }
  }
  ...
  async function handleRsvp(eventId: string) {
    ...
    try {
      ...
      setActionError(err instanceof ApiClientError ? err.message : 'تعذر التسجيل في الفعالية.');
    }
  }
